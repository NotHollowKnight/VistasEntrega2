        ...
        <div class="row">
            ...
            <div>
                ...
                <div class="row my-5" >
                    ...
                    <div class="col-2"></div>
                    <a href="#" class="col-2 btn text-primary fs-5" id="ModificarUsuarioDiv">Modificar</a>
            ...
            <div>
                ...
                <div class="row my-5">
                    ...
                    <div class="col-4 fs-5 fw-semibold">Tipo de cuenta</div>
                    <div class="col fs-5">Personal</div>
